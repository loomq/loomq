...
class ResolveWalModeTest {
    ...
    void durableAckModeOverridesIntentWalMode() {
        ...
        WalMode resolved = IntentCommandService.resolveWalModeForTest(PrecisionTierCatalog.defaultCatalog(), intent, AckMode.DURABLE);
    ...
    void tierDefaultWalModeAppliesWhenIntentAndAckModeUnset() {
        ...
        WalMode resolved = IntentCommandService.resolveWalModeForTest(PrecisionTierCatalog.defaultCatalog(), intent, null);
